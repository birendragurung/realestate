...
db.getSearchResults = function (parameters) {
	//parameters.function = "getPropertyBySql";
	this.sendSearchRequest(parameters);
}

db.sendSearchRequest = function (parameters){
